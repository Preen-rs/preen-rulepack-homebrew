...
2. Run the `sign-manifest` workflow to generate and commit `manifest.sig` with keyless Sigstore.
...
Note:
- `manifest.sig` must exist in the repo/tag for git-install verification.
